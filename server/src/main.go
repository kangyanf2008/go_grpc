...
func main() {
	...
	flag.StringVar(&consul_addr, "consul_addr", "172.31.1.21:8501", "host:port of the service stuats monitor interface")
	flag.StringVar(&status_monitor_addr, "monitor_addr", "172.21.48.3:54321", "host:port of the service stuats monitor interface")
	flag.StringVar(&service_name, "service_name", "worker", "name of the service")
	flag.StringVar(&service_ip, "ip", "172.21.48.3", "service serve ip")
